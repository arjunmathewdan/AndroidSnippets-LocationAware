...
public class SMSReceiver extends BroadcastReceiver
{
    ...
    private static LocationActivity LA;
    View v;
      
    public void setActivity(LocationActivity activity) {
    	String tag = "AMD";
    	this.LA = activity;
    	Log.d(tag, "INSIDE setActivity()");
    	if (this.LA == null)
    		Log.d(tag,"setActivity - LA null");
...
//                	LA.useCoarseFineProviders(v);
             //   	LA.setup();
                	if(LA != null)
                	{	
                		Log.d(tag, "CALLING setup()");
                		LA.setup();
                	}
                	else
                		Log.d(tag, "LA IS NULL!!!!");
                }
            }                   
    	}
}
